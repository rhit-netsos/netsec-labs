 ...
 *
 * Compute the checksum for a TCP packet before sending it.
 *
 * @param tcp     The TCP header to compute the checksum over.
 * @param ip      The IP header to compute the checksum over.
 *
 * @return the computed checksum.
 */
